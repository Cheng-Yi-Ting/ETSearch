...
function parseFile() {
    ...
    jsonFile.readFile(filePath, function (err, jsonData) {
        ...
        for (var i = 0; i < jsonData.length; ++i) {
            ...
            if( jsonData[i].image=="https://talk.ltn.com.tw/assets/images/logo180x180.png"){
                continue;
            }
            if( jsonData[i].image=="https://news.ltn.com.tw/assets/images/all/250_ltn.png"){
                continue;
            }
            if( jsonData[i].image=="https://img.appledaily.com.tw/images/fb_sharelogo_1.jpg"){
                continue;
            }
            // if( jsonData[i].description<20){
            //     continue;
            // }
            if( jsonData[i].image.length<10){
                continue;
            }
            bulkcount += 1
            bulkOps.push({
